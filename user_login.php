...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("SELECT resident_id, name FROM residents WHERE email = ? AND password = ?");
...
<nav class="navbar navbar-dark">
    <div class="container">
        <a class="navbar-brand" href="#">VDM User Portal</a>
    </div>
</nav>
...
<div class="container mt-4">
    <div class="login-container">
        <div class="login-header">
            <h3>User Login</h3>
            <p>Enter your credentials to access the Resident portal</p>
        </div>
